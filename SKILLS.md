...
|----------------------|-----------------------|-----------------------|----------------------|----------------------|
| 🟩 value             | 🟩 if elif else       | 🟩 recursion          | 🟩 list             | 🟩 refactoring       |
| 🟩 identifier        | 🟩 loops              | 🟩 function           | 🟩 instance         | 🟩 code review       |
| 🟩 variable          | 🟩 is                 | 🟩 return             | 🟩 dict             | 🟦 antipatterns      |
| 🟩 constant          | 🟩 None               | 🟩 signature          | 🟩 tuple            | 🟦 paradigm          |
| 🟩 global            | 🟩 class              | 🟩 argument           | 🟦 hash table       | 🟩 algorithm         |
| 🟩 literal           | 🟩 pass               | 🟩 parameter          | 🟦 linked list      | 🟦 magic numbers     |
| 🟩 expression        | 🟩 while              | 🟩 pure function      | 🟦 queue            | 🟩 hardcode          |
| 🟩 heap              | 🟩 for                | 🟩 lambda             | 🟦 stack            | 🟩 complexity        |
| 🟩 type              | 🟩 for..in            | 🟩 side effects       | 🟦 deque            | 🟩 decomposition     |
| 🟩 primitive types   | 🟩 del                | 🟩 closure            | 🟦 serialization    | ⬜️ spaghetti         |
|	🟩 reference         | 🟩 await              | 🟩 partial            | 🟩 mixin, extend    | ⬜️ silver bullet     |
| 🟩 yield             | 🟩 raise              | 🟩 curry              | 🟨 iterator         | ⬜️ not invented here |
| 🟩 lexical scope     | 🟩 try except         | 🟩 chaining           | 🟨 typed arrays     | 🟩 dead code         |
| 🟩 code block        | 🟩 equality operators | 🟩 higher order       | 🟨 Map              | 🟦 unreachable code  |
| 🟩 lambda            | 🟩 logical operators  | 🟩 callback           | 🟩 Set              | 🟩 duplicate code    |
| 🟩 self              | 🟩 bitwise operators  | 🟩 listener           | ⬜️ weak collections | 🟩 exception         |
| 🟩 iterator.         | 🟩 break, continue    | 🟩 pipe               | ⬜️ Proxy            | 🟩 return early      |
| 🟩 generator         | 🟩 match, case        | 🟩 compose            | ⬜️ Symbol           | 🟩 linter            |
| 🟩 async def		     | 🟩 Exception          | 🟩 memoize            | 🟨 string parsing   | ⬜️ prettier          |
| 🟩 type							 | 🟩 assert             | 🟩 factory            | 🟨 timers           | 🟩 unittest          |
| 🟩 list          	   |                       | 🟩 hinting            | 🟨 EventEmitter     | 🟩 git               |
| 🟩 **kwargs       	 |                       | 🟩 wrapper            | 🟨 RegExp           | 🟩 github            |
| 🟩 *args        		 |                       | 🟩 default parameters | 🟨 global           |           						|
| 🟩 isinstance        |                       | 🟩 @decorator         | 🟨 undefined        |                      |
